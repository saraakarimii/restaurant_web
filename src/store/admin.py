...
#         return obj.item.price
    ...
    #     return obj.bill.owner.user.first_name + f'{ obj.bill.owner.user.last_name}'

# @admin.register(bill)
# class bill_admin(admin.ModelAdmin):
#     list_display = ['owner_first_bill','owner_last_bill',"branche_bill","items","ordered_date"]
...
#     @admin.display(description="owner first name")
#     def owner_first_bill(self,obj):
#         return obj.owner.user.first_name 
#     @admin.display(description="owner last name")
#     def owner_last_bill(self,obj):
#         return obj.owner.user.last_name
